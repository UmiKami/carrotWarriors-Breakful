    ...
    <>
      <div className="timeSlots">
        ...
        <div className="timeSlots__buttons">
          ...
          <button onClick={()=>selectedTime("22:00")}>10:00 PM</button>
          <button onClick={()=>selectedTime("22:30")}>10:30 PM</button>
          <button onClick={()=>selectedTime("23:00")}>11:00 PM</button>
          <button onClick={()=>selectedTime("23:30")}>11:30 PM</button>
        </div>
